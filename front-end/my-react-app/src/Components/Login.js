...
function Login() {
  ...
  const handleLogin = () => {
    ...
    if (email && password) {
      ...
      //Redirect to the main and perform other actions as needed
    } else {
        ...
        <div className='container'>
          ...
          <div className='row'>
            <ul class="social-nav">
              <li class="social-item nav-item">
                ...
                <li class="social-item nav-item">
                  <a href="https://twitter.com/ArinzeTim" class="social-link">
                  <svg viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="25px" height="25px">
                    <title>
                      Twitter icon
                    </title>
                ...
                <li class="social-item nav-item">
                  <a href="https://instagram.com/mister_tim1/" class="social-link">
                  <svg viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="25px" height="25px">
                    <title>
                      Instagram icon
                    </title>
          ...
          <div className="row">
            <div className="col-1-2">
              <small>© 2024 TimWeb3, Tim's Masterclass.</small>
            </div>
            <div class="col-1-2">
